...
export const registerStep2Schema = z
  .object({
    ...
    email: z.string().min(1, { message: 'register.step2.error.email' }).email({ message: 'register.step2.error.invalidEmail' }),
    ...
    confirmPassword: z.string().min(1, { message: 'register.step2.error.confirmPassword' }),
  })
...
export const registerStep3Schema = z.object({
  projectName: z.string().min(1, { message: 'register.step3.error.projectName' }),
  projectType: z.string().min(1, { message: 'register.step3.error.projectType' }),
  country: z.string().min(1, { message: 'register.step3.error.country' }),
  city: z.string().min(1, { message: 'register.step3.error.city' }),
  styles: z.array(z.string()).min(1, { message: 'register.step3.error.styles' }),
});
