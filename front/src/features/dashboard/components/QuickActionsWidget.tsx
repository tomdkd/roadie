      ...
      <div>
        ...
        <div className="space-y-2.5">
          ...
          >
            ...
            <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
              PDF
            </span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
              PDF
            </span>
          </button>
        </div>
