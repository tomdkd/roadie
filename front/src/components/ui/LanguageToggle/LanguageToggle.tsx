  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      >
        ...
        <span className="tracking-wider uppercase">{currentLanguage.code}</span>
        <ChevronDown
      ...
      {isOpen && (
        <div className="animate-in fade-in zoom-in-95 absolute right-0 z-50 mt-2 w-40 rounded-2xl border border-slate-200 bg-white/95 p-1.5 shadow-xl backdrop-blur-md transition-all duration-100 dark:border-slate-800 dark:bg-slate-900/95">
          <div className="px-2 py-1 text-[10px] font-bold tracking-wider text-slate-400 uppercase dark:text-slate-500">
            {i18n.t('language')}
          </div>
